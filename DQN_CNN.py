...
# GLOBAL VARIABLES
# Paths
MODEL_PATH_SAVE = "./Models/CNN/model_0.ckpt"
MODEL_PATH_LOAD = "./Models/CNN/model_0.ckpt"

# Not text files. Some of these arrays are 4D which can't be neatly written to a text file.
W_conv1_textfile_path_save = "./Data/CNN/CNN_variables/W_conv1.npy"
b_conv1_textfile_path_save = "./Data/CNN/CNN_variables/b_conv1.npy"

W_conv2_textfile_path_save = "./Data/CNN/CNN_variables/W_conv2.npy"
b_conv2_textfile_path_save = "./Data/CNN/CNN_variables/b_conv2.npy"

W_fc_textfile_path_save = "./Data/CNN/CNN_variables/W_fc.npy"
b_fc_textfile_path_save = "./Data/CNN/CNN_variables/b_fc.npy"

W_out_textfile_path_save = "./Data/CNN/CNN_variables/W_out.npy"
b_out_textfile_path_save = "./Data/CNN/CNN_variables/b_out.npy"

# This is for viewing the model and summaries in Tensorboard
LOGDIR = "./Logs/CNN/log0"
